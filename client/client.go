...
// APIClient manages communication with the StampWallet API Server API v0.1.0
...
type APIClient struct {
	...
	ItemDefinitionsApi *ItemDefinitionsApiService

	LocalCardsApi *LocalCardsApiService
	...
	VirtualCardsApi *VirtualCardsApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.BusinessApi = (*BusinessApiService)(&c.common)
